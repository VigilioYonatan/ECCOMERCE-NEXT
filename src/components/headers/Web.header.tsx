...
import { AuthHeaderComponent } from "~/services/auth/components/AuthHeader.component";
...
export function WebHeader() {
    ...
    return (
        <header id="header" className="dark:bg-paper-dark bg-paper-light">
            <div className="container mx-auto flex flex-col md:flex-row gap-2 justify-between items-center  px-4 dark:text-white ">
                ...
                <ul className="flex items-center text-xs gap-5 ">
                    <li className="relative cursor-pointer py-1  flex items-center gap-2 hover-dropwdown">
                        <div className=" flex  items-center gap-1 py-1 cursor-pointer hover:text-primary">
